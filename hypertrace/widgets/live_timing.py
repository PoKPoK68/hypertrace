"""hypertrace/widgets/live_timing.py — Live timing panel with camera focus control."""
...
if TYPE_CHECKING:
    ...
    from hypertrace.widgets.broadcast import BroadcastState
...
class LiveTimingPanel(QWidget):
    ...
    def __init__(self, reader: "DataReader", bc_state: "BroadcastState") -> None:
        ...
        self.setWindowTitle("HyperTrace Live Timing")
