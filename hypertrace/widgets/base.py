...
class BaseWidget(QWidget):
    ...
    def __init__(
        ...
        # DIAGNOSTIC ONLY — set HYPERTRACE_DIAG_OPAQUE=1 to disable per-pixel-alpha
        ...
        if not os.environ.get("HYPERTRACE_DIAG_OPAQUE"):
    ...
    def _draw_panel(self, p, w: float, h: float, accent: bool = True) -> None:
        ...
        from hypertrace.utils.theme import T, panel_brush, border_pen, accent_hairline
    ...
    def on_data(self) -> None:
        """Called every active timer tick — read `hypertrace.calc.module_info.minfo`."""
