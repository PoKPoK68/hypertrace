...
from hypertrace.utils.theme import T, label_font, panel_brush, border_pen
...
"""
        ...
        # ── Master broadcast switch — gates REST (localhost:6397), which
        # nothing except the broadcast overlays and Live Timing needs. Kept
        # independent of the Stream tab's own toggle: streaming the 9 primary
        # overlays never needs REST, and Live Timing is its own standalone
        # window, not served over the stream server at all.
