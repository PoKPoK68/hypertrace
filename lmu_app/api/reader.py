"""lmu_app/api/reader.py — Compatibility snapshot adapter.
...
`lmu_app.calc.module_info.minfo` and `lmu_app.calc.api.api` directly.
...
from lmu_app.calc.module_control import mctrl
from lmu_app.calc.module_info import VehicleData, minfo
