"""lmu_app/calc/modules/module_fuel.py — Fuel + Virtual Energy consumption.
...
from lmu_app.calc._calc_util import (
...
from lmu_app.calc.module_info import FuelInfo, minfo
